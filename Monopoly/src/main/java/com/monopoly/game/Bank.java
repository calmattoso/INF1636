...
public class Bank {
	...
	/**
	 * Pays the player his fee when he reaches the start square
	 * 
	 * @param p		The player
	 */
	...
	public void mortgageTerrain(TerrainCard t){
		if(t.getPropertyQuantity(PropertyType.HOUSE) != 0 || t.getPropertyQuantity(PropertyType.HOTEL) != 0){
			Bank.getBank().sellAllProperties(t);
		}
		t.addMortgage();
